...
import util.math.geom.shapes.Circle2D;
import util.math.geom.shapes.Ellipse2D;
import util.math.geom.shapes.IGeometric2D;
import util.math.geom.shapes.Line2D;
import util.math.geom.shapes.Point2D;
import util.math.geom.shapes.Polyline2D;
import util.math.geom.shapes.Rect2D;
import util.math.geom.shapes.TransformMatrix2D;
